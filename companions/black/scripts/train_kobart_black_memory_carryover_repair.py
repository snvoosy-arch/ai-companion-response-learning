...
ALL_PATH = ROOT / "data" / "kobart_memory_carryover_repair_all_20260416.jsonl"
OUTPUT_DIR = ROOT / "models" / "kobart_black_memory_carryover_repair_20260416"
REPORT_PATH = ROOT / "reports" / "kobart_black_memory_carryover_repair_report_20260416.json"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="black memory carry-over repair용 KoBART 미세보정 train 런처"
    )
