...
SOURCE_PATH = ROOT / "data" / "kobart_memory_carryover_phrase_repair_seed_20260416.json"
ALL_PATH = ROOT / "data" / "kobart_memory_carryover_phrase_repair_all_20260416.jsonl"
TRAIN_PATH = ROOT / "data" / "kobart_memory_carryover_phrase_repair_train_20260416.jsonl"
EVAL_PATH = ROOT / "data" / "kobart_memory_carryover_phrase_repair_eval_20260416.jsonl"
SUMMARY_PATH = ROOT / "reports" / "kobart_memory_carryover_phrase_repair_summary_20260416.json"
        ...
        converted.append(
            {
                ...
                "meta": {
                    ...
                    "constraints": row.get("constraints") or [],
                    "phrasing_plan": row.get("phrasing_plan") or {},
                    "source_type": "kobart_memory_carryover_phrase_repair",
                },
            }
        )
