...
REWRITE_PATH = ROOT / "data" / "rewrite_results" / "daily_response_rewrites_curated_v7_1344.jsonl"
ALL_PATH = ROOT / "data" / "daily_response_rewritten_sft_v7_all.jsonl"
TRAIN_PATH = ROOT / "data" / "daily_response_rewritten_sft_v7_train.jsonl"
EVAL_PATH = ROOT / "data" / "daily_response_rewritten_sft_v7_eval.jsonl"
SUMMARY_PATH = ROOT / "reports" / "daily_response_rewritten_sft_v7_summary.json"
...
def main() -> None:
        ...
        rewrite_rows.append(
            {
                ...
                "rewrite": {
                    ...
                    "reply_style": reply_style,
                    "notes": "curated natural rewrite v7 action+style+user-variant conditioned",
                },
            }
        )
        sft_rows.append(
    ...
    summary = {
        ...
        "source_type": "curated_clean_rewrite_v7_action_style_user_conditioned",
    }
