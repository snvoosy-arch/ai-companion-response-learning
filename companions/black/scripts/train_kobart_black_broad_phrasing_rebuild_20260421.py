...
SOURCE_PATH = ROOT / "data" / "black_broad_phrasing_rebuild_seed_20260421.json"
ALL_PATH = ROOT / "data" / "black_broad_phrasing_rebuild_all_20260421.jsonl"
TRAIN_PATH = ROOT / "data" / "black_broad_phrasing_rebuild_train_20260421.jsonl"
EVAL_PATH = ROOT / "data" / "black_broad_phrasing_rebuild_eval_20260421.jsonl"
SUMMARY_PATH = ROOT / "reports" / "black_broad_phrasing_rebuild_summary_20260421.json"
OUTPUT_DIR = ROOT / "models" / "kobart_black_broad_phrasing_rebuild_20260421"
REPORT_PATH = ROOT / "reports" / "kobart_black_broad_phrasing_rebuild_report_20260421.json"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="broad phrasing rebuild용 black KoBART build + train 런처")
