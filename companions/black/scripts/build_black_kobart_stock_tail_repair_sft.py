...
SOURCE_PATH = ROOT / "data" / "kobart_stock_tail_repair_seed_20260417.json"
ALL_PATH = ROOT / "data" / "kobart_stock_tail_repair_all_20260417.jsonl"
TRAIN_PATH = ROOT / "data" / "kobart_stock_tail_repair_train_20260417.jsonl"
EVAL_PATH = ROOT / "data" / "kobart_stock_tail_repair_eval_20260417.jsonl"
SUMMARY_PATH = ROOT / "reports" / "kobart_stock_tail_repair_summary_20260417.json"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="stock-tail focused black KoBART repair 데이터를 만든다.")
        ...
        converted.append(
            {
                ...
                "meta": {
                    ...
                    "constraints": row.get("constraints") or [],
                    "phrasing_plan": row.get("phrasing_plan") or {},
                    "source_type": "kobart_stock_tail_repair",
                },
            }
        )
