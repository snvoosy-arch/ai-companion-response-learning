...
BUILD_SCRIPT = ROOT / "scripts" / "build_black_kobart_malformed_closure_repair_sft.py"
TRAIN_SCRIPT = ROOT / "scripts" / "train_kobart_black.py"
ALL_PATH = ROOT / "data" / "kobart_malformed_closure_repair_all_20260417.jsonl"
OUTPUT_DIR = ROOT / "models" / "kobart_black_malformed_closure_repair_20260417"
REPORT_PATH = ROOT / "reports" / "kobart_black_malformed_closure_repair_report_20260417.json"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="malformed-closure focused black KoBART repair용 build + train 런처")
