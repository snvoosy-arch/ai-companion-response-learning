...
BUILD_SCRIPT = ROOT / "scripts" / "build_black_kobart_comparison_bitterness_repair_sft.py"
TRAIN_SCRIPT = ROOT / "scripts" / "train_kobart_black.py"
ALL_PATH = ROOT / "data" / "kobart_comparison_bitterness_repair_all_20260415.jsonl"
OUTPUT_DIR = ROOT / "models" / "kobart_black_comparison_bitterness_repair_20260415"
REPORT_PATH = ROOT / "reports" / "kobart_black_comparison_bitterness_repair_report_20260415.json"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="comparison/bitterness focused black KoBART repair용 build + train 런처"
    )
    ...
    parser.add_argument(
        "--model-name-or-path",
        default=str(ROOT / "models" / "kobart_black_phrasing_repair_20260415"),
