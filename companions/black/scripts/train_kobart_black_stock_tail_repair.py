...
BUILD_SCRIPT = ROOT / "scripts" / "build_black_kobart_stock_tail_repair_sft.py"
TRAIN_SCRIPT = ROOT / "scripts" / "train_kobart_black.py"
ALL_PATH = ROOT / "data" / "kobart_stock_tail_repair_all_20260417.jsonl"
OUTPUT_DIR = ROOT / "models" / "kobart_black_stock_tail_repair_20260417"
REPORT_PATH = ROOT / "reports" / "kobart_black_stock_tail_repair_report_20260417.json"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="stock-tail focused black KoBART repair용 build + train 런처")
    ...
    parser.add_argument(
        "--model-name-or-path",
        default=str(ROOT / "models" / "kobart_black_phrase_stability_repair_20260417"),
