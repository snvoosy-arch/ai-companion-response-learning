...
BUILD_SCRIPT = ROOT / "scripts" / "build_black_kobart_phase_a_integrated_sft_20260419.py"
TRAIN_SCRIPT = ROOT / "scripts" / "train_kobart_black.py"
ALL_PATH = ROOT / "data" / "kobart_black_phase_a_integrated_all_20260419.jsonl"
OUTPUT_DIR = ROOT / "models" / "kobart_black_phase_a_integrated_20260419"
REPORT_PATH = ROOT / "reports" / "kobart_black_phase_a_integrated_report_20260419.json"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Phase A integrated black KoBART build + train launcher")
