...
BUILD_SCRIPT = ROOT / "scripts" / "build_black_duo_phrasing_rebuild_20260422.py"
TRAIN_SCRIPT = ROOT / "scripts" / "train_kobart_black.py"
SOURCE_PATH = ROOT / "data" / "black_broad_plus_duo_phrasing_rebuild_all_20260422.jsonl"
OUTPUT_DIR = ROOT / "models" / "kobart_black_broad_plus_duo_phrasing_rebuild_20260422"
REPORT_PATH = ROOT / "reports" / "kobart_black_broad_plus_duo_phrasing_rebuild_report_20260422.json"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="broad+duo phrasing rebuild용 black KoBART build + train 런처")
    ...
    parser.add_argument(
        ...
        default=str(
            ...
            / "black"
            / "generation"
            / "kobart_black_broad_phrasing_rebuild_v2_20260422"
        ),
    )
