...
BUILD_SCRIPT = ROOT / "scripts" / "build_black_kobart_phase_a_runtime_aligned_sft_20260419.py"
...
OUTPUT_DIR = ROOT / "models" / "kobart_black_phase_a_runtime_aligned_20260419"
REPORT_PATH = ROOT / "reports" / "kobart_black_phase_a_runtime_aligned_report_20260419.json"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Runtime-aligned Phase A integrated black KoBART build + train launcher")
    ...
    parser.add_argument(
        ...
        help="통합 학습 시작 베이스 KoBART 경로 또는 Hugging Face 이름",
    )
