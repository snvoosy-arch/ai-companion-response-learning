...
SOURCE_PATH = ROOT / "data" / "kobart_comparison_bitterness_repair_seed_20260415.json"
ALL_PATH = ROOT / "data" / "kobart_comparison_bitterness_repair_all_20260415.jsonl"
TRAIN_PATH = ROOT / "data" / "kobart_comparison_bitterness_repair_train_20260415.jsonl"
EVAL_PATH = ROOT / "data" / "kobart_comparison_bitterness_repair_eval_20260415.jsonl"
SUMMARY_PATH = ROOT / "reports" / "kobart_comparison_bitterness_repair_summary_20260415.json"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="comparison/bitterness focused black KoBART repair 데이터를 만듭니다.")
        ...
        converted.append(
            {
                ...
                "meta": {
                    ...
                    "constraints": row.get("constraints") or [],
                    "phrasing_plan": row.get("phrasing_plan") or {},
                    "source_type": "kobart_comparison_bitterness_repair",
                },
            }
        )
