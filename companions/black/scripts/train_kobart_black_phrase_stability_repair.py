...
OUTPUT_DIR = ROOT / "models" / "kobart_black_phrase_stability_repair_20260417"
REPORT_PATH = ROOT / "reports" / "kobart_black_phrase_stability_repair_report_20260417.json"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="phrase-stability focused black KoBART repair용 build + train 런처")
